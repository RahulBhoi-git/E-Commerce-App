      ...
      switch (method) {
        ...
        case "razorpay":
          ...
          if (responseRazorpay.data.success) {
            ...
            console.log("ORDER:", responseRazorpay.data.order);
            const userIdFromContext = localStorage.getItem('userId');
            initPay(responseRazorpay.data.order, userIdFromContext);
          }
          break;
        default:
          break;
      ...
      <div className="mt-8">
        ...
        <div className="mt-12">
          ...
          <div className="w-full text-end">
            <button
              type="submit"
              className="bg-black text-sm my-8  py-3 px-8 my-8 text-white cursor-pointer"
            >
              Place Order
            </button>
          </div>
