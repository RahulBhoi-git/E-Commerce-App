    ...
    <div className="border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100">
      ...
      <div className="flex gap-12 sm:gap-12 flex-col sm:flex-row">
        ...
        <div className="flex-1">
              ...
              <div className="flex gap-2">
                {productData.sizes.map((item, index) => (
                  <button
                    ...
                    className={` py-2 px-4 bg-gray-200 ${item === size ? "border border-orange-500" : ""}`}
                    key={index}
                  >
                    {item}
                  </button>
          ...
          <button
            onClick={() => addToCart(productData._id, hasSize?size:"default")}
      ...
      <div className="mt-20">
        ...
        <div className="flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500">
          <p>
            ...
            pages that tell customers about your product. A good product
            description describes your product's features and benefits,
            acknowledges the problem it solves, and declares why it's the best
            product for the job.
          </p>
          <p>
            It is a digital extension of traditional commerce, allowing
