...
const Add = ({ token }) => {
  ...
  const isSaree = category === "Women" && subCategory === "Saree";

  // All sub categories
  const subCategoryOptions = {
    Men: ["Topwear", "Bottomwear", "Winterwear"],
    Women: ["Topwear", "Bottomwear", "Winterwear", "Saree"],
    Kids: ["Topwear", "Bottomwear", "Winterwear"],
  };

  // state declaration for saree
  useEffect(() => {
      ...
      <div className="flex flex-col sm:flex-row gap-2 w-full sm:gap-8">
        ...
        <div>
          ...
          >
            ...
            <option value="Wintewear">Winterwear</option> */}
          </select>
        </div>
